...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=config('DJANGO_JWT_ACCESS_TOKEN_TTL', cast=int)),
    "REFRESH_TOKEN_LIFETIME": timedelta(minutes=config('DJANGO_JWT_REFRESH_TOKEN_TTL', cast=int)),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API documentation for the Cinemax project',
    'VERSION': '1.0.0',
...
CELERY_RESULT_BACKEND = f'{BASE_REDIS_URL}/1'
...
STRIPE_SUCCESS_URL_BASE = config('STRIPE_SUCCESS_URL_BASE', cast=str)
STRIPE_CANCEL_URL_BASE = config('STRIPE_CANCEL_URL_BASE', cast=str)